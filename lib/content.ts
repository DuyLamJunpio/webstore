...
const MAC_DINH: SiteContent = {
  slides: [
    {
      id: "mac-dinh-1",
      media: "/images/warehouse/Black, White, and Red Color Block Jacket.png",
      mediaType: "image",
      poster: null,
      mobile: null,
      alt: "Người mẫu mặc áo khoác phối khối màu của mùa mới",
      heading: "Chào mừng quốc khánh 2/9",
      subheading: "Những món đồ hấp dẫn đang chờ đón bạn!",
      ctaLabel: "Mua ngay",
      ctaLink: "/shop",
    },
    {
      id: "mac-dinh-2",
      media: "/images/warehouse/Brown Minimalist Coming Soon Banner.png",
      mediaType: "image",
      poster: null,
      mobile: null,
      alt: "Người mẫu mặc áo khoác da lúc hoàng hôn",
      heading: "Khai trương cửa hàng mới",
      subheading: "Đừng bỏ lỡ những ưu đãi đặc biệt trong tuần lễ khai trương!",
      ctaLabel: null,
      ctaLink: null,
    },
    {
      id: "mac-dinh-3",
      media: "/images/warehouse/COVER.png",
      mediaType: "image",
      poster: null,
      mobile: null,
      alt: "Đăng ký ",
      heading: "Thiết kế riêng cho bạn",
      subheading: "Khám phá bộ sưu tập độc quyền và tạo phong cách riêng của bạn với những sản phẩm được thiết kế đặc biệt.",
      ctaLabel: null,
      ctaLink: null,
    },
  ],
