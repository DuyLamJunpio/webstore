    ...
    <section className="shell section">
      <div className="border border-line bg-[#f7f7f7] p-6 sm:p-10 lg:p-14">
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((item) => {
            ...
            return (
              ...
              >
                <div>
                  <span className="text-[10px] font-bold uppercase tracking-widest text-[#8f633e]">
                    {item.tag}
                  </span>
                ...
                <div className="mt-6 flex items-center gap-2 border-t border-line pt-4 text-xs font-semibold text-ink">
                  <Icon className="h-4 w-4 text-[#8f633e]" />
        ...
        <div className="mt-10 flex flex-wrap items-center justify-between gap-4 border-t border-line pt-6">
          ...
          <Link
            href="/shop"
            className="inline-flex h-11 items-center gap-2 bg-ink px-7 text-xs font-bold uppercase tracking-wider text-white transition-colors hover:bg-[#8f633e]"
          >
