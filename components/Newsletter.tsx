        ...
        <div className="p-6 sm:p-10 md:p-12 lg:p-14">
          ...
          <div className="max-w-2xl">
            ...
            <p className="mt-3 text-sm sm:text-base leading-relaxed text-[#555555]">
              Đăng ký nhận bản tin để nhận ngay mã ưu đãi giảm <strong>10%</strong> cho đơn hàng đầu tiên, đồng thời
            ...
            <div className="lg:col-span-7 flex flex-col justify-between gap-6">
              <div className="grid gap-3.5 sm:grid-cols-2">
                ...
                >
                  <div className="flex items-center justify-between">
                    <span className="grid h-9 w-9 place-items-center bg-white border border-line text-[#8f633e]">
                  ...
                  <div className="mt-4">
                    ...
                    <p className="mt-1 text-[11px] text-muted flex items-center gap-1">
                      <Clock className="h-3 w-3 text-[#8f633e]" /> 8:30 – 22:00 (Hằng ngày)
                    </p>
                  </div>
                </a>
              ...
              <div className="grid grid-cols-3 gap-2 border border-line bg-[#f7f7f7] p-4 text-center">
                <div className="flex flex-col items-center gap-1">
                  <Shield className="h-4 w-4 text-[#8f633e]" />
                ...
                <div className="flex flex-col items-center gap-1 border-x border-line px-1">
                  <Return className="h-4 w-4 text-[#8f633e]" />
                ...
                <div className="flex flex-col items-center gap-1">
                  <Ship className="h-4 w-4 text-[#8f633e]" />
            ...
            <div className="lg:col-span-5 flex flex-col justify-between border border-line bg-[#f7f7f7] p-6 sm:p-8">
              <div>
                ...
                <p className="mt-2 text-xs sm:text-[13px] leading-relaxed text-[#555555]">
                  Nhận ngay mã giảm giá <strong>10%</strong> áp dụng cho đơn hàng đầu tiên của bạn trên hệ thống.
                </p>
              </div>

              <div className="mt-6">
                {done ? (
                  <div className="border border-[#8f633e] bg-white p-5 text-ink fade-in">
                    <div className="flex items-center gap-2.5">
                      <span className="grid h-6 w-6 place-items-center bg-[#8f633e] text-white font-bold text-xs shrink-0">
                    ...
                    <div className="mt-3.5 bg-[#f4f4f4] p-3 border border-line text-center">
                      ...
                      <p className="text-base font-mono font-black text-[#8f633e] tracking-widest mt-0.5">
                        LIFEWEAR10
                      </p>
                    </div>
                    <p className="mt-2.5 text-[11px] text-muted text-center">
                      Áp dụng giảm 10% cho đơn hàng đầu tiên khi thanh toán trên website.
                    </p>
                  </div>
                ) : (
                  <form onSubmit={onSubmit} className="flex flex-col gap-3">
                    ...
                    <button
                      type="submit"
                      className="h-11 w-full bg-[#8f633e] px-6 text-xs font-bold uppercase tracking-wider text-white transition-colors hover:bg-[#734d2c] active:scale-98 flex items-center justify-center gap-2"
                    >
                      <span>ĐĂNG KÝ NHẬN MÃ GIẢM 10%</span>
                ...
                <p className="mt-4 text-[11px] text-muted text-center flex items-center justify-center gap-1.5">
                  <Shield className="h-3.5 w-3.5 text-[#8f633e]" /> Chúng tôi tôn trọng quyền riêng tư và cam kết không spam.
                </p>
              </div>
            </div>
          </div>
